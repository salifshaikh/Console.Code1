            ...
            <div className="w-full px-4">
              ...
              <form action="/register" method="post">
                  ...
                  <div className="mb-6">
                    ...
                    <input type="submit" className="shadow-submit dark:shadow-submit-dark flex w-full items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white duration-300 hover:bg-primary/90" value="Sign in"/>
                  </div>
